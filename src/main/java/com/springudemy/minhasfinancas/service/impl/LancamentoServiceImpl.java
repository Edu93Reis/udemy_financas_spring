...
import com.springudemy.minhasfinancas.model.repository.LancamentoRepository;
...
public class LancamentoServiceImpl implements LancamentosService {
	...
	public void validar(Lancamento lancamento) {
		...
		if(lancamento.getUsuario() == null || lancamento.getId() == null) {
			throw new RegraNegocioException("Informe usuário válido!!");
		}
		...
		if(lancamento.getTipo() == null) {
			throw new RegraNegocioException("Informe tipo de lançamento!!");
		}
	}
